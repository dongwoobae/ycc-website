 ...
 *
 * 페이지 액션 버튼(등록 등)은 히어로 안이 아니라 히어로 바로 아래 좌측에 둔다 —
 * 설교 관리의 "지금 동기화"와 같은 위치로, 시선 흐름상 더 잘 보인다.
 */
export default function AdminPageHero({ title, image, eyebrow, subtitle }: AdminPageHeroProps) {
  return (
