...
export default function FullBleedBand() {
  return (
    <section className="bg-accent-deep py-24 text-white min-[960px]:py-28">
      <Container
        size="wide"
        className="grid items-center gap-12 min-[960px]:grid-cols-[1.1fr_0.9fr] min-[960px]:gap-16"
      >
        <Reveal>
          ...
          <p className="mt-6 max-w-xl text-[clamp(15px,1.6vw,18px)] leading-[1.85] text-white/85">
            {churchInfo.denomination} {churchInfo.name}는 예배와 말씀 위에 서서, 기도로 하나님의 통치를 구하며, 이웃과
            다음 세대를 섬김으로 하나님 나라가 이루어지기를 갈망합니다.
          </p>
