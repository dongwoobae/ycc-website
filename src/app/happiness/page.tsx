          ...
          <div className="mx-auto max-w-3xl">
            <Reveal variant="fade-up">
              <div className="space-y-6 text-[17.5px] leading-9 text-ink-muted">
                <p>
                  행복선언은 단순한 긍정의 말이나 세상적인 형통을 비는 구호가 아닙니다. 우리의 형편이 늘 완벽하다는 뜻도
                  아닙니다.
                </p>
                <p>
            ...
            <Reveal variant="fade-up" delay={220}>
              <div className="space-y-6 text-[17.5px] leading-9 text-ink-muted">
                <p>
                  우리는 이 고백을 통해 예배의 은혜를 삶으로 이어갑니다. 예수 안에서 하나님의 통치를 받고, 하나님 나라의
                  백성으로 살아가며, 우리 삶과 가정과 교회 가운데 주님의 나라가 이루어지기를 갈망합니다.
                </p>
              </div>
            </Reveal>
